...
export class Running extends State {
    ...
    handleInput(input) {
        ...
        var dust = new Dust(this.game, this.game.player.x + this.game.player.width * 0.5, this.game.player.y + this.game.player.height);
...
export class Rolling extends State {
    ...
    handleInput(input) {
        let fire = new Fire(this.game, this.game.player.x + this.game.player.width * 0.5, this.game.player.y + this.game.player.height * 0.5);
